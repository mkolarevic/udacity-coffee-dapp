...
contract SupplyChain is Ownable, ConsumerRole, DistributorRole, FarmerRole, RetailerRole {
  // Define 'owner' (inherited from 'Ownable')
  // address owner;
  ...
  modifier forSale(uint _upc) {
    require(items[_upc].itemState == State.ForSale, "Item must be ForSale");
    _;
  }
  ...
  function harvestItem(
    ...
    emit Harvested(_upc);
    itemsHistory[_upc].push(string(msg.data));
  }
    ...
    checkValue(_upc)
  {
    ...
    items[_upc].distributorID = _make_payable(msg.sender);
    ...
    checkValue(_upc)
  {
    ...
    items[_upc].ownerID = msg.sender;
    items[_upc].retailerID = _make_payable(msg.sender);
